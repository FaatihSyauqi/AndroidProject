		...
		<nav class="navbar">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" id="titlePage" href="home">City App - Configuration</a>
		...
		<section class="content">
			...
			<div class="container-fluid">
				...
				<div class="row clearfix">	
					<div class="col-sm-12">
						<div class="col-sm-6">
							<div class="card" id="configDataAbout" style="display:none">
								<div class="header">
									<h2><strong>About Config</strong></h2>
								</div>
								<div class="body">
									<div class="row clearfix">
										
										<form id="saveFormAbout" action="#" name="svFormAbout">
											<div class="col-sm-12">
												
												<b>Description</b>
												<div class="form-group">
													<div class="form-line">
														<input type="text" id="frmAppDescription" class="form-control" required/>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="form-line">
														...
														<input type="text" id="frmAppFacebook" class="form-control" required/>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="form-line">
														<input type="text" id="frmAppTwitter" class="form-control"  required/>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="form-line">
														<input type="text" id="frmAppInstagram" class="form-control" required/>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="form-line">
														<input type="text" id="frmAppYoutube" class="form-control" required/>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="form-line">
														<input type="email" id="frmAppEmail" class="form-control" required/>
													</div>
												</div>
												...
												<div class="form-group">
													<div class="form-line">
														<input type="text" id="frmAppWebsite" class="form-control" required/>
													</div>
												</div>
						...
						<div class="col-sm-6">
							<div class="card" id="configDataAds" style="display:none">
								<div class="header">
									<h2><strong>Ads Config</strong></h2>
								</div>
								<div class="body">
									<div class="row clearfix">
										<form id="saveFormAds" action="#" name="svFormAds">
											<div class="col-sm-12">
												<div class="form-group">
													
													<input id="checkAdBanner" type="checkbox"/>
													<label for="checkAdBanner"><b>Enable Ad Banner</b></label>
													
												</div>
												
												<div class="form-group">
													
													<input id="checkAdInterstitial" type="checkbox"/>
													<label for="checkAdInterstitial"><b>Enable Ad Interstitial</b></label>
													
												</div>
												
												<div class="form-group">
													
													<input id="checkAdNative" type="checkbox"/>
													<label for="checkAdNative"><b>Enable Ad Native</b></label>
